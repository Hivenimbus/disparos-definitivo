<template>
  <div class="space-y-6">
    <section class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
        <div class="flex flex-col items-center space-y-3">
          ...
          <div>
            <p class="text-lg font-semibold text-yellow-700">Página em Manutenção</p>
            <p class="text-sm text-yellow-700 mt-1">Estamos trabalhando nesta seção. O histórico voltará em breve.</p>
          </div>
        </div>
      </section>

    <section class="bg-white rounded-lg shadow p-6 relative overflow-hidden hidden">
